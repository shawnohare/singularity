...
" Singularity Dark scheme by Shawn O&#x27;Hare (http://github.com/shawnohare/singularity)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-singularity-light.sh"
  endif
endif
...
hi clear
syntax reset
let g:colors_name = "base16-singularity-light"
